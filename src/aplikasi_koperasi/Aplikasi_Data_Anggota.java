 ...
 * @author enoh
 */
public class Aplikasi_Data_Anggota extends javax.swing.JDialog {
...
private String[] label = {"Kode Anggota","Nama","Alamat","Tempat Lahir",
    ...
    /**
     * Creates new form Aplikasi_Data_Anggota
     */
    public Aplikasi_Data_Anggota(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        kon.setKoneksi();
        BacaTabelAnggota();
    ...
    private void tbl_anggotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_anggotaMouseClicked
        ...
        transaksi.KodeAnggota   = tbl_anggota.getValueAt(tabelAnggota, 0).toString();
        transaksi.NamaAnggota   = tbl_anggota.getValueAt(tabelAnggota, 1).toString();
        transaksi.AlamatAnggota = tbl_anggota.getValueAt(tabelAnggota, 2).toString();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aplikasi_Data_Anggota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Aplikasi_Data_Anggota dialog = new Aplikasi_Data_Anggota(new javax.swing.JFrame(), true);
